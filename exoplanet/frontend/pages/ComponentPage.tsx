          ...
          <div className="cards-grid">
            ...
            <div className="card">
              ...
              <p className="card-description">
                Offering a first-of-its-kind hybrid method to detect exoplanets
                using both direct and indirect approaches.
              </p>
              <button className="card-button" onClick={handleExpDetect}>
                Explore →
              </button>
            </div>
            ...
            <div className="card">
              <img
                ...
                src="https://iili.io/33etkfn.png"
                alt="Basketball"
              />
              <h3 className="card-title">
                Extraterrestrial Mineral Identifier
              </h3>
              <p className="card-description">Styles made for your games</p>
              <button className="card-button" onClick={handleMineral}>
                Explore →
              </button>
            </div>
            ...
            <div className="card">
              ...
              <button className="card-button" onClick={handleAtmos}>
                Explore →
              </button>
            </div>
            ...
            <div className="card">
              ...
              />
              <h3 className="card-title">
                Stellar Age & Metallicity Predictor
              </h3>
